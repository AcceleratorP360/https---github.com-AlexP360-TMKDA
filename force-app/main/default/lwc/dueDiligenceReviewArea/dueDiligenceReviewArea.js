...
import SEVERITY_FIELD from '@salesforce/schema/P360_Review_Area__c.TMKDA_Severity__c';
import SOURCE_FIELD from '@salesforce/schema/P360_Review_Area__c.TMKDA_Source__c';


const columns = [
    { label: 'Name',initialWidth: 170, fieldName: 'Name', editable: false },
  /*  {label: 'Summary', fieldName: 'P360_Summary__c',type: 'text',wrapText:true,editable:false},*/
    {
        label: 'Severity',initialWidth: 160 , fieldName: 'TMKDA_Severity__c', type: 'picklistColumn', editable: true, typeAttributes: {
            placeholder: 'Choose Severity', options: { fieldName: 'pickListCompletionOptions' }, 
            value: { fieldName: 'Severity' }, // default value for picklist,
            context: { fieldName: 'Id' } // binding account Id with context variable to be returned back
        }
    },
    { label: 'Source',initialWidth: 170, fieldName: 'TMKDA_Source__c', editable: false }, 
    { label: 'Review Point',initialWidth: 150,class: "slds-align_absolute-center", fieldName: 'P360_Review_Point__c'},
