...
import CATEGORY_ID_FIELD from '@salesforce/schema/P360_DD_Category__c.P360_DA_Category_ID__c';
...
const columns = [
    ...
    { label: 'High Risk Customer Type', fieldName: 'TMKDA_High_Risk_Customer_Type__c',class:"slds-line-height_reset", editable: false, cellAttributes: {
  ...
  /* { label: 'Inherent Risk ',initialWidth: 150,class: "slds-align_absolute-center", fieldName: 'P360_CT_Inherent_risk__c', type: 'image', 
    ...
    {
        label: 'Summary',wrapText:true, class:'center',initialWidth: 420,fieldName: 'P360_Summary_Final_Assessment__c', type: 'text',wrap: true,innerWidth: 150, editable: false, cellAttributes: {
            class: '.newspaper'
           // set the width to 50
        }
    },      
