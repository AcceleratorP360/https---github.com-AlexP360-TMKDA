...
import fetchLookupData from '@salesforce/apex/P360_CustomLookupController.fetchLookupData';
import fetchDefaultRecord from '@salesforce/apex/P360_CustomLookupController.fetchDefaultRecord';
   ...
   // initial function to populate default selected lookup record if defaultRecordId provided  
    connectedCallback(){
       //  if(this.defaultRecordId != ''){
            ...
            .then((result) => {
                if(result != null){
                    console.log('----this.defaultRecordId ',result)
