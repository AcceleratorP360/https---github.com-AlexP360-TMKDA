    ...
    setupTable : function(component) {
        ...
        action.setCallback(this,function(response){
            if(response.getState() === "SUCCESS"){
                ...
                var primaryLinked = [];              
                var Comment = []; /* added by vardhani 01/03/2024*/
                ...
                for(var key in result){
                    ...
                    /*added by VA*/
                    if(key === 'TMKDA_Answer_date__c'){
                        Object.entries(result['	TMKDA_Answer_date__c']).forEach(([key, value]) => answers.push({label:key,value:value}));
                    }
                     if(key === 'TMKDA_Answer_number__c'){
                        Object.entries(result['	TMKDA_Answer_number__c']).forEach(([key, value]) => answers.push({label:key,value:value}));
                    }
                    
                      if(key === '	TMKDA_Answer_formula__c'){
                        Object.entries(result['TMKDA_Answer_formula__c']).forEach(([key, value]) => answers.push({label:key,value:value}));
                    }                  
                    ...
                    /* added by vardhani 01/03/2024*/
                     if(key === 'P360_Comment__c'){
                        Object.entries(result['P360_Comment__c']).forEach(([key, value]) => Comment.push({label:key,value:value}));
                    } 
                ...
                if(storedSobjName !== 'P360_Due_Diligence__c'){
                    ...
                    {label: "Severity", fieldName: "TMKDA_Severity__c", editable: false, type:"picklist", selectOptions:severity, resizable:true}, /* changed type = text and made readonly by vardhani 01/03/2024*/
                    {label: "Review Point", fieldName: "P360_Review_Point__c", type:"text", sortable:true, resizable:true,bwrapText:true,
                     Attributes: { class: 'two-line-wrap' },initialWidth :50},
                   ...
                   /* {label: "Assesment", fieldName: "P360_Pass_Fail__c", editable: true, type:"picklist", selectOptions:assesment, resizable:true},*/ /* changes made by vardhani*/
                    {label: "Source", fieldName: "TMKDA_Source__c", type:"text", editable: true, sortable: true, resizable:true,wrapText:true},
                  ...
                  /*  {label: "Connect To Primary", fieldName: "P360_IS_Primary_Connect_On_Linked_Area__c", type:"text", resizable:true},*/
                         ...
                         /* {label: "Completion marker", fieldName: "P360_Completion_Marker__c", editable: true, type:"picklist", selectOptions:completionMarker, resizable:true, required :false},  //  commented as not required in columnto exist line of code required : false added by vardhani 23/02  */    
                         {label: "Comment", fieldName: "P360_Comment__c", type:"text", editable: true, sortable: true, resizable:true,wrapText:true},                         
                         {label: "Guidance", fieldName: "P360_Master_Guidance__c", type:"text", sortable: true, resizable:true, wrapText:true,
                         cellAttributes: { class: 'two-line-wrap' }},
                         /* {label: "Guidance", fieldName: "P360_DA_RA_Guidance__c", type:"text", sortable: true, resizable:true} P360_Master_Guidance__c*/
                         ];
                }else{
                ...
                cols = [
                    {label: "Review Area", fieldName: "accountLink", type:"link", sortable: true, resizable:true, 
                     attributes:{label:{fieldName:"Name"}, title:"Click to View(New Window)", target:"_blank"}},
                    {label: "Severity", fieldName: "TMKDA_Severity__c", editable: false, type:"picklist", selectOptions:severity, resizable:true}, /* changes made severity as read only , type = text,  by vardhani 01/03/2024 */
                   ...
                   /* {label: "Assesment", fieldName: "P360_Pass_Fail__c", editable: false, type:"picklist", selectOptions:assesment, resizable:true},*/ /* changes made by vardhani*/
                    ...
                    {label: "Connect To Primary", fieldName: "P360_IS_Primary_Connect_On_Linked_Area__c", type:"text", resizable:true},*/
                         /* added label : Linked  by vardhani 26/02/2024*/
                         {label: "Linked", fieldName: "P360_IS_Primary_Connect_On_Linked_Area__c", type:"text", resizable:true},
                         /*{label: "Completion marker", fieldName: "P360_Completion_Marker__c", editable: false, type:"picklist", selectOptions:completionMarker, resizable:true},  */      //added required : true by vardhani 23/02 and commented as not required in table
                         {label: "Comment", fieldName: "P360_Comment__c", type:"text",editable: false, sortable: true, resizable:true},
