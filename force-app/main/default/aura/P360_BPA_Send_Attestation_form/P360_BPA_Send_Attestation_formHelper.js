        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS") {
                ...
                if(getReturnValue != null){
                    var options = getReturnValue.map(opt => ({ value: opt.TMKDA_CH_Contact__c, label: opt.TMKDA_CH_Contact__c.Name }));
                cmp.set("v.selectedContact", getReturnValue[0].TMKDA_CH_Contact__c);
                }else{
